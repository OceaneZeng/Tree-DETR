#!/usr/bin/env bash
# Evaluate a stage-0 checkpoint on one GPU to avoid DDP COCO all_gather.
set -euo pipefail
...
CHECKPOINT="${CHECKPOINT:-${PROJECT_ROOT}/exps/iod/40+20x2/order0/stage0_base/checkpoint.pth}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/exps/iod/40+20x2/order0/stage0_base_eval}"
