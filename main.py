...
def get_args_parser():
    ...
    parser.add_argument('--cat-proposals', default='',
                        help='Selective-search proposal database generated by prepare_cat_proposals.py')
...
def main(args):
    ...
    if args.paper_baseline == 'cat' and not Path(args.cat_proposals).is_file():
        raise ValueError('CAT requires an existing --cat-proposals file')
